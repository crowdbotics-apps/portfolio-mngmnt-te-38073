"""
Django settings for portfolio_mngmnt_te_38073 project.
...
ROOT_URLCONF = 'portfolio_mngmnt_te_38073.urls'
...
WSGI_APPLICATION = 'portfolio_mngmnt_te_38073.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "portfolio_mngmnt_te_38073 API",
    "DESCRIPTION": "API documentation for portfolio_mngmnt_te_38073 App",
    "VERSION": "v1",
}
