...
## Project Structure
    ...
    ├── portfolio_mngmnt_te_38073  # Django project configurations
...
1. Clone this repo and `cd portfolio_mngmnt_te_38073`
...
2. Clone this repo and `cd portfolio_mngmnt_te_38073`
